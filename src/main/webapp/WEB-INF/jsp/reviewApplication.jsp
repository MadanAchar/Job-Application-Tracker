...
<head>
    ...
    <title>Review Application | JobTrack</title>
...
<div class="app-shell">
    ...
    <header class="topbar">
        <div class="topbar-title">Review Application</div>
    ...
    <main class="content-area">
        <div class="content-inner">
            <div class="page-header">
                <div>
                    <h1 class="page-title">Placement Review</h1>
                    <p class="page-subtitle">Review the student's application and update its placement status.</p>
                </div>
            </div>
    ...
    class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-input" type="text" id="companyName" readonly name="companyName" value="${application.companyName}" required>
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="jobRole">Job Role</label>
                        <input class="form-input" type="text" id="jobRole" readonly name="jobRole" value="${application.jobRole}" required>
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="location">Location</label>
                        <input class="form-input" type="text" id="location" readonly name="location" value="${application.location}">
                    </div>
    ...
    <option value="Pending"
        ${application.status eq 'Pending' ? 'selected' : ''}>
        Pending
    </option>

    <option value="Shortlisted"
        ${application.status eq 'Shortlisted' ? 'selected' : ''}>
        Shortlisted
    </option>

    <option value="Interview"
        ${application.status eq 'Interview' ? 'selected' : ''}>
        Interview
    </option>

    <option value="Selected"
        ${application.status eq 'Selected' ? 'selected' : ''}>
        Selected
    </option>

    <option value="Rejected"
        ${application.status eq 'Rejected' ? 'selected' : ''}>
        Rejected
    </option>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-input" type="date" id="applicationDate" readonly name="applicationDate" value="${application.applicationDate}" required>
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="deadline">Deadline</label>
                        <input class="form-input" type="date" id="deadline" readonly name="deadline" value="${application.deadline}">
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="jobSkills">Job Skills</label>
                        <input class="form-input" type="text" id="jobSkills" readonly name="jobSkills" value="${application.jobSkills}">
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="skillMatchPercent">Skill Match (%)</label>
                        <input class="form-input" type="number" id="skillMatchPercent" readonly name="skillMatchPercent" min="0" max="100" value="${application.skillMatchPercent}">
                    </div>

                    <div class="form-group full-width">
                        <label class="form-label" for="notes">Placement Remarks</label>
    ...
    <a class="button button-secondary"
       href="${pageContext.request.contextPath}/resumes/${application.resumeFilename}"
       target="_blank">
